            ...
            <div class="editInfo">
                ...
                <div class="mitad">
                    <form method="post" action="editar_perfil.php" id="editForm" enctype="multipart/form-data">
                        ...
                        <img src="<?php echo $usuario_photo; ?>" alt="Foto de perfil actual" width="100"
                            style="margin-top: 10px; margin-left: 5rem;"><br>

                        <label style="margin-top: 10px; margin-left: 5rem;">Name</label><br>
                        <input type="text" name="new_name" required
                            style="width: 416.93px; height: 52px; margin-top: 10px; margin-bottom: 10px; margin-left: 5rem; border-radius: 12px; border: 1px solid;"><br>

                        <label style="margin-top: 10px; margin-left: 5rem;">Bio</label><br>
                        <textarea name="new_bio"
                            style="width: 416.93px; height: 91.58px; margin-top: 10px; margin-bottom: 10px; margin-left: 5rem; border-radius: 12px; border: 1px solid;"></textarea>
                        <br>
                        ...
                        <input type="submit" value="Save"
                            style="width: 82px; height: 38px; margin-top: 10px; margin-bottom: 10px; margin-left: 5rem; border-radius: 8px; background-color: rgba(47, 128, 237, 1);">
                    </form>
                </div>
            </div>
        </div>
